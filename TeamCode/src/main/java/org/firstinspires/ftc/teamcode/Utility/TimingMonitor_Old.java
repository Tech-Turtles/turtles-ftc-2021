 ...
 */
public class TimingMonitor_Old {
    ...
    public TimingMonitor_Old(RobotHardware opMode) {
        this.opMode = opMode;
    ...
    public void displayMaxTimes() {
        ...
        if(firstLoopCompleted) {
            ...
            for (String checkpoint : checkpointNames) {
                ...
                opMode.telemetry.addData(checkpoint, opMode.df_precise.format(checkpointMaxTimes.get(index)));
                index++;
            }
        }
