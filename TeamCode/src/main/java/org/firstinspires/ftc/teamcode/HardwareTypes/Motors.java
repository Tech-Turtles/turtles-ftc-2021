...
public enum Motors {
    ...
    FRONT_LEFT("front left", ExpansionHubs.HUB1, MotorTypes.DRIVE, DcMotorSimple.Direction.FORWARD, ZeroPowerBehavior.FLOAT, RunMode.RUN_WITHOUT_ENCODER),
    FRONT_RIGHT("front right", ExpansionHubs.HUB1, MotorTypes.DRIVE, DcMotorSimple.Direction.REVERSE, ZeroPowerBehavior.FLOAT, RunMode.RUN_WITHOUT_ENCODER),
    BACK_LEFT("back left", ExpansionHubs.HUB1, MotorTypes.DRIVE, DcMotorSimple.Direction.REVERSE, ZeroPowerBehavior.FLOAT, RunMode.RUN_WITHOUT_ENCODER),
    BACK_RIGHT("back right", ExpansionHubs.HUB1, MotorTypes.DRIVE, DcMotorSimple.Direction.REVERSE, ZeroPowerBehavior.FLOAT, RunMode.RUN_WITHOUT_ENCODER),
    ...
    LAUNCHER("launcher", ExpansionHubs.HUB2, MotorTypes.OTHER, DcMotorSimple.Direction.REVERSE, ZeroPowerBehavior.FLOAT, RunMode.RUN_USING_ENCODER),
